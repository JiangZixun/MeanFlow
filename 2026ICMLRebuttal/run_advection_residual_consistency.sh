...
OUT_DIR="${OUT_DIR:-/mnt/data1/MeanFlow/2026ICMLRebuttal/advection_residual_consistency}"

"${PYTHON_BIN}" /mnt/data1/MeanFlow/2026ICMLRebuttal/advection_residual_consistency.py \
  --config "${CONFIG}" \
