...
pretrained_himawari8_vae_name = "himawari8_vae_512_16x16x64_154E.pt"
pretrained_himawari8_earthformerunet_name = "himawari8_earthformerunet_16x16_v2.pt"
pretrained_himawari8_cuboidmamba_name = "himawari8_cuboidmamba_256.pt"
pretrained_himawari8_vss3dunet_name = "himwari8_vss3dunet_128.pt"
pretrained_himawari8_alignment_name = "himawari8_alignment_avgx.pt"

pretrained_moving_mnist_vae_name = "moving_mnist_vae.pt"
pretrained_moving_mnist_vss3dunet_name = "moving_mnist_vss3dunet.pt"
pretrained_moving_mnist_alignment_name = "moving_mnist_alignment_avgx.pt"

pretrained_i3d_400_name = "pretrained_i3d_400.pt"
pretrained_i3d_600_name = "pretrained_i3d_600.pt"

pretrained_himawari8_teacher_name = "himawari8_swinlstm.pt"
pretrained_moving_mnist_teacher_name = "moving_mnist_swinlstm.pt"
# file_id_dict = {
