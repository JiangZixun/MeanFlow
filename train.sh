...
/home/jzx/anaconda3/envs/torchcfm/bin/python train_JiT_RFDPIC_Gaussion.py \
    --config configs/JiT_RFDPIC_Gaussion.yaml \
    --rfdpic_config configs/rfdpic_config.yaml \
    --rfdpic_ckpt pretrained_models/pretrained_RFDPIC_Dual_Rotation_Dyn.pt \
    --log_dir logs/JiT_RFDPIC_Gaussion_1e-4_flowratio_1.0 \
    --sample_steps 10 \
    --batch_size 8 \
    --mode train \
    --gpus 1 \
